...
@ManagedBean(name = "reporteEvaluacionesGerenteController")
@SessionScoped
public class ReporteEvaluacionesGerenteController {
    ...
    public ReporteEvaluacionesGerenteController() throws Exception {
        ...
        if (sesion.getAttribute("reportevaluacionesgerentes").toString().compareTo("nada") != 0) {
            evaluaciones = (List<Evaluacion>) sesion.getAttribute("reportevaluacionesgerentes");
    ...
    public void ProcesarGeneral() throws IOException {
        ...
        Dependencia ubicacion = (Dependencia) sesion.getAttribute("ubicacion");
        List<EmpleadoArray> empleados = this.reporteEmpleadosnoGerentes(current.getId().toString(), ubicacion.getId().toString());
    ...
    public void iniciar() {
        ...
        sesion.setAttribute("reportevaluacionesgerentes", evaluaciones);
    ...
    private java.util.List<com.pangea.evap.services.EmpleadoArray> reporteEmpleadosnoGerentes(java.lang.String identificadorEvaluacion, java.lang.String identificadorGerencia) {
        com.pangea.evap.services.GestionEvaluacion port = service.getGestionEvaluacionPort();
        return port.reporteEmpleadosnoGerentes(identificadorEvaluacion, identificadorGerencia);
    }
}
