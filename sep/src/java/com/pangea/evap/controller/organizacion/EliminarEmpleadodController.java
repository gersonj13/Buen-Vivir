 ...
 */
// @Author Ing. Gerson Ramirez 
@ManagedBean(name = "eliminarEmpleadodBean")
@RequestScoped
public class EliminarEmpleadodController {
    ...
    public EliminarEmpleadodController() {
        FacesContext fc = FacesContext.getCurrentInstance();
        ExternalContext ec = fc.getExternalContext();
    ...
    private void eliminarEmpleado(com.pangea.evap.services.Empleado empleado) {
        com.pangea.evap.services.GestionEvaluacion port = service.getGestionEvaluacionPort();
        port.eliminarEmpleado(empleado);
    }
